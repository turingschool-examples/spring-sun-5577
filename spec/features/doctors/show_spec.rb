...
RSpec.describe "Doctor Show", type: :feature do
  before do
    ...
    @patient1 = @doctor1.patient.create!(name: "Patient1Name", age: 20)
    @patient2 = @doctor1.patient.create!(name: "Patient1Name", age: 20)
    @patient3 = @doctor1.patient.create!(name: "Patient1Name", age: 20)
    @patient4 = @doctor1.patient.create!(name: "Patient1Name", age: 20)
